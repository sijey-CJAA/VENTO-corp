...
<head>
    ...
    <title>VENTO-corp Stock Holder Dashboard</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="d-flex min-vh-100 flex-column flex-lg-row">
        ...
        <div class="offcanvas-lg offcanvas-start sidebar flex-column flex-shrink-0 p-3" tabindex="-1" id="sidebarMenu" style="width: 280px;">
            ...
            <div class="offcanvas-body flex-column h-100 px-0 px-lg-2">
                ...
                <div class="mb-auto">
                    <span class="d-block text-secondary small text-uppercase fw-bold mb-3 px-3">Stock Holder Navigation</span>
                    <ul class="nav flex-column mb-auto gap-1">
                        <li class="nav-item">
                            <a href="stockHolder.php" class="nav-link <?php echo $current_page == 'stockHolder.php' ? 'active' : ''; ?>">
                                Dashboard
                            </a>
                        </li>
                    </ul>
